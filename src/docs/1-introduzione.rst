...
Questo materiale (e il suo gemello `Appunti di Pratica per
Chitarra Jazz <https://appunti-pratica-per-chitarra-jazz.readthedocs.io>`__) nasce libero.
...
Ogni parte può vivere anche al di fuori di questi appunti, in qualunque
forma e contesto.
...
- iscriverti al mio canale
  `YouTube <https://www.youtube.com/@fabsguitarspace>`__ o condividerne
  il link
