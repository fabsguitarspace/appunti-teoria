...
- **Triade maggiore**
  ...
  È la triade più stabile e definita.
  Chiarisce immediatamente il centro.
  Non spinge, afferma.
...
- **Triade minore**
  ...
  Meno assertiva della maggiore.
  Più introspettiva.
  Stabile, ma con un colore diverso.
...
Triade minore
 Lettera seguita da “m” oppure “–”:
 Cm, G–


Triade diminuita
 Lettera seguita da “dim” oppure simbolo °:
 Bdim, B°

Triade aumentata
 Lettera seguita da “aug” oppure simbolo +:
 Caug, C+
...
.. image:: 
   _static/music/triadi.*
   :width: 500px

.. raw:: html

   <audio controls class="audio-controls">
      <source src="_static/music/triadi.mp3" type="audio/mp3">
   </audio>
...
.. image:: 
   _static/music/triade-maggiore-rivolti.*
   :width: 500px

.. raw:: html

   <audio controls class="audio-controls">
      <source src="_static/music/triade-maggiore-rivolti.mp3" type="audio/mp3">
   </audio>


.. image:: 
   _static/music/triade-minore-rivolti.*
   :width: 500px

.. raw:: html

   <audio controls class="audio-controls">
      <source src="_static/music/triade-minore-rivolti.mp3" type="audio/mp3">
   </audio>


.. image:: 
   _static/music/triade-diminuita-rivolti.*
   :width: 500px

.. raw:: html

   <audio controls class="audio-controls">
      <source src="_static/music/triade-diminuita-rivolti.mp3" type="audio/mp3">
   </audio>


.. image:: 
   _static/music/triade-aumentata-rivolti.*
   :width: 500px

.. raw:: html

   <audio controls class="audio-controls">
      <source src="_static/music/triade-aumentata-rivolti.mp3" type="audio/mp3">
   </audio>
...
.. image:: 
   _static/music/triade-maggiore-spread.*
   :width: 500px

.. raw:: html

   <audio controls class="audio-controls">
      <source src="_static/music/triade-maggiore-spread.mp3" type="audio/mp3">
   </audio>

Le triadi a parti larghe sono il ponte tra:
...
.. image:: 
   _static/music/triade-sus2-rivolti.*
   :width: 500px

.. raw:: html

   <audio controls class="audio-controls">
      <source src="_static/music/triade-sus2-rivolti.mp3" type="audio/mp3">
   </audio>
...
.. image:: 
   _static/music/triade-sus4-rivolti.*
   :width: 500px

.. raw:: html

   <audio controls class="audio-controls">
      <source src="_static/music/triade-sus4-rivolti.mp3" type="audio/mp3">
   </audio>
...
.. list-table::
   ...
   * - Cadd9
     - 1 - 3 - 5 - 9
     - .. image:: _static/music/estensione-add9.*
          :width: 200px

       .. raw:: html

          <audio controls class="audio-controls">
           <source src="_static/music/estensione-add9.mp3" type="audio/mp3">
          </audio>
   * - C6/9
     - 1 - 3 - 5 - 6 - 9
     - .. image:: _static/music/estensione-69.*
          :width: 200px

       .. raw:: html

          <audio controls class="audio-controls">
           <source src="_static/music/estensione-69.mp3" type="audio/mp3">
          </audio>
   * - CΔ9
     - 1 - 3 - 5 - 7 - 9
     - .. image:: _static/music/estensione-maj9.*
          :width: 200px

       .. raw:: html

          <audio controls class="audio-controls">
           <source src="_static/music/estensione-maj9.mp3" type="audio/mp3">
          </audio>
   * - CΔ♯11 o Clyd
     - 1 - 3 - 5 - 7 - 9 - ♯11
     - .. image:: _static/music/estensione-maj11.*
          :width: 200px

       .. raw:: html

          <audio controls class="audio-controls">
           <source src="_static/music/estensione-maj11.mp3" type="audio/mp3">
          </audio>


L'etichetta **add9** si usa per indicare che alla triade viene aggiunta solo la nona maggiore, mentre la settima è esclusa.

Quando invece usi l'etichetta **lyd**, stai facendo un salto di prospettiva, non stai più descrivendo “come è costruito” ma stai dicendo a quale universo sonoro appartiene, comunica subito una funzione armonica precisa. 
Questo sarà più chiaro quando parleremo dell'armonizzazione della scala maggiore.
...
.. list-table::
   ...
   * - Cm(add9)
     - 1 - ♭3 - 5 - 9
     - .. image:: _static/music/estensione-madd9.*
          :width: 200px

       .. raw:: html

          <audio controls class="audio-controls">
           <source src="_static/music/estensione-madd9.mp3" type="audio/mp3">
          </audio>
   * - Cm9
     - 1 - ♭3 - 5 - ♭7 - 9
     - .. image:: _static/music/estensione-m9.*
          :width: 200px

       .. raw:: html

          <audio controls class="audio-controls">
           <source src="_static/music/estensione-m9.mp3" type="audio/mp3">
          </audio>
   * - Cm11
     - 1 - ♭3 - 5 - ♭7 - 11
     - .. image:: _static/music/estensione-m11.*
          :width: 200px

       .. raw:: html

          <audio controls class="audio-controls">
           <source src="_static/music/estensione-m11.mp3" type="audio/mp3">
          </audio>
   * - CmΔ9
     - 1 - ♭3 - 5 - 7 - 9
     - .. image:: _static/music/estensione-mmaj9.*
          :width: 200px

       .. raw:: html

          <audio controls class="audio-controls">
           <source src="_static/music/estensione-mmaj9.mp3" type="audio/mp3">
          </audio>


I simboli m9 e m11 implicano l'inclusione della settima minore (7)... gli accordi m11 possono includere oppure no anche la nona maggiore (9). Nel jazz, il suono minore “di base” non è la triade minore, ma l'accordo a quattro voci m7.
...
.. list-table::
   ...
   * - C9
     - 1 - ♭3 - 5 - ♭7 - 9
     - .. image:: _static/music/estensione-9.*
          :width: 200px

       .. raw:: html

          <audio controls class="audio-controls">
           <source src="_static/music/estensione-9.mp3" type="audio/mp3">
          </audio>
   * - C7#11
     - 1 - ♭3 - 5 - ♭7 - ♯11
     - .. image:: _static/music/estensione-711.*
          :width: 200px

       .. raw:: html

          <audio controls class="audio-controls">
           <source src="_static/music/estensione-711.mp3" type="audio/mp3">
          </audio>
   * - C13
     - 1 - ♭3 - 5 - ♭7 - 13
     - .. image:: _static/music/estensione-13.*
          :width: 200px

       .. raw:: html

          <audio controls class="audio-controls">
           <source src="_static/music/estensione-13.mp3" type="audio/mp3">
          </audio>
   * - C7♭9
     - 1 - ♭3 - 5 - ♭7 - ♭9
     - .. image:: _static/music/estensione-7f9.*
          :width: 200px

       .. raw:: html

          <audio controls class="audio-controls">
           <source src="_static/music/estensione-7f9.mp3" type="audio/mp3">
          </audio>
   * - C7♯9
     - 1 - ♭3 - 5 - ♭7 - ♯9
     - .. image:: _static/music/estensione-7s9.*
          :width: 200px

       .. raw:: html

          <audio controls class="audio-controls">
           <source src="_static/music/estensione-7s9.mp3" type="audio/mp3">
          </audio>
   * - C7♭13
     - 1 - ♭3 - 5 - ♭7 - ♭13
     - .. image:: _static/music/estensione-7f13.*
          :width: 200px

       .. raw:: html

          <audio controls class="audio-controls">
           <source src="_static/music/estensione-7f13.mp3" type="audio/mp3">
          </audio>
...
.. list-table::
   ...
   * - C7♭9♯11
     - 1 - ♭3 - 5 - ♭7 - ♭9 - ♯11
     - .. image:: _static/music/estensione-7f9s11.*
          :width: 200px

       .. raw:: html

          <audio controls class="audio-controls">
           <source src="_static/music/estensione-7f9s11.mp3" type="audio/mp3">
          </audio>
   * - C7♯9♯11
     - 1 - ♭3 - 5 - ♭7 - ♯9 - ♯11
     - .. image:: _static/music/estensione-7s9s11.*
          :width: 200px

       .. raw:: html

          <audio controls class="audio-controls">
           <source src="_static/music/estensione-7s9s11.mp3" type="audio/mp3">
          </audio>
   * - C7♭9♭13
     - 1 - ♭3 - 5 - ♭7 - ♭9 - ♭13
     - .. image:: _static/music/estensione-7f9f13.*
          :width: 200px

       .. raw:: html

          <audio controls class="audio-controls">
           <source src="_static/music/estensione-7f9f13.mp3" type="audio/mp3">
          </audio>
   * - C7♯9♭13
     - 1 - ♭3 - 5 - ♭7 - ♯9 - ♭13
     - .. image:: _static/music/estensione-7s9f13.*
          :width: 200px

       .. raw:: html

          <audio controls class="audio-controls">
           <source src="_static/music/estensione-7s9f13.mp3" type="audio/mp3">
          </audio>
   * - C9♭13
     - 1 - ♭3 - 5 - ♭7 - 9 - ♭13
     - .. image:: _static/music/estensione-9f13.*
          :width: 200px

       .. raw:: html

          <audio controls class="audio-controls">
           <source src="_static/music/estensione-9f13.mp3" type="audio/mp3">
          </audio>
   * - C13♭9
     - 1 - ♭3 - 5 - ♭7 - ♭9 - 13
     - .. image:: _static/music/estensione-13f9.*
          :width: 200px

       .. raw:: html

          <audio controls class="audio-controls">
           <source src="_static/music/estensione-13f9.mp3" type="audio/mp3">
          </audio>
...
Gli accordi **maggiori** e **minori**, da soli, tendono a stare fermi.
Non perché siano immobili, ma perché non contengono una direzione obbligata.
...
La **dominante** è diversa.
Non sta ferma nemmeno quando è ferma.
...
Per questo leggere un accordo come un oggetto isolato è sempre riduttivo.
Un accordo è sempre un evento in un contesto.
